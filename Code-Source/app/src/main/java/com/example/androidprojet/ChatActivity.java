...
import com.example.androidprojet.adapter.ChatAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void  sendMessage() {
        ...
        if(conversionId != null) {
            ...
            conversion.put(Constants.KEY_RECEIVED_NAME, receivedUser.name);
            conversion.put(Constants.KEY_RECEIVED_IMAGE, receivedUser.image);
    ...
    private void checkForConversionRemotly(String senderId, String receivedId) {
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
